              ...
              <Col sm={8}>
                <InputMasked
                  ...
                  onChange={async (e) => {
                    ...
                    initialValues.userData.cpf = await valueWithouSymbols;
                    setFieldValue("userData.cpf", valueWithouSymbols);
                  }}
...
//   const putClients = async (clientJson) => {
//     try {
//       const formClient = await JSON.parse(clients);
//       const objClient = await {
//         userData: {
//           completeName: formClient.completeName,
//           cpf: formClient.cpf,
//           birthDate: formClient.birthDate,
//           cellPhone: formClient.cellPhone,
//           phoneFixed: formClient.phoneFixed,
//           email: formClient.email,
//           alertEmail: formClient.alertEmail,
//         },
//         logo: formClient.logo,
//         address: {
//           cep: formClient.cep,
...
//           district: formClient.district,
//           city: formClient.city,
//           state: formClient.state,
//           alertEmail: formClient.userEmailAlert,
//         },
//       };
//       console.log("keyy", objClient);
//       const resp = await api.put("/client/1", objClient);
//       const userData = resp.data;
//       // setUpdate(null);
//       // setClients(null);
//       // setClientData({
